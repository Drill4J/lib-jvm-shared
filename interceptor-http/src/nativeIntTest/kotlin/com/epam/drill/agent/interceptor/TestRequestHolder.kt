...
object TestRequestHolder : RequestHolder {
    ...
    override fun remove() { localRequest = null }

    override fun retrieve(): DrillRequest? = localRequest

    override fun store(drillRequest: DrillRequest) { localRequest = drillRequest }
