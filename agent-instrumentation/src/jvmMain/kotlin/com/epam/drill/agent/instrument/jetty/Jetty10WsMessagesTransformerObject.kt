...
abstract class Jetty10WsMessagesTransformerObject : HeadersProcessor, PayloadProcessor, AbstractTransformerObject() {
    ...
    private fun transformJsrUpgradeListener(ctClass: CtClass) = ctClass
        .getMethod("onHandshakeResponse", "(Lorg/eclipse/jetty/client/HttpRequest;Lorg/eclipse/jetty/client/HttpResponse;)V")
        .insertCatching(
    ...
    private fun transformFrameHandlerFactory(ctClass: CtClass) = ctClass
        .getMethod("newFrameHandler", "(Ljava/lang/Object;Lorg/eclipse/jetty/websocket/core/server/ServerUpgradeRequest;Lorg/eclipse/jetty/websocket/core/server/ServerUpgradeResponse;)Lorg/eclipse/jetty/websocket/core/FrameHandler;")
        .insertCatching(
            CtBehavior::insertAfter,
            """
            java.util.Map/*<java.lang.String, java.lang.String>*/ allHeaders = new java.util.HashMap();
