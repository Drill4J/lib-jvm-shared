 ...
 */
abstract class ParallelFluxTransformerObject(agentConfiguration: AgentConfiguration) :
    ...
    override fun transform(className: String, ctClass: CtClass) {
        ctClass.getMethod("onAssembly", "(Lreactor/core/publisher/ParallelFlux;)Lreactor/core/publisher/ParallelFlux;")
            .insertCatching(
                ...
                """
              $1 = (reactor.core.publisher.ParallelFlux) ${PublisherAssembler::class.java.name}.${PublisherAssembler::onAssembly.name}($1, reactor.core.publisher.ParallelFlux.class, ${this::class.java.name}.INSTANCE);                    
            """.trimIndent()
            )
    }
}