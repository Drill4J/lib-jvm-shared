 ...
 */
abstract class MonoTransformerObject(agentConfiguration: AgentConfiguration) :
    ...
    override fun transform(className: String, ctClass: CtClass) {
        ctClass.getMethod("onAssembly", "(Lreactor/core/publisher/Mono;)Lreactor/core/publisher/Mono;").insertCatching(
            ...
            """
                    $1 = (reactor.core.publisher.Mono) ${PublisherAssembler::class.java.name}.${PublisherAssembler::onAssembly.name}($1, reactor.core.publisher.Mono.class, ${this::class.java.name}.INSTANCE);
                """.trimIndent()
        )
    }
}