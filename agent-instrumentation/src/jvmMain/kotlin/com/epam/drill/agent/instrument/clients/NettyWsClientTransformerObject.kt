...
abstract class NettyWsClientTransformerObject : HeadersProcessor, AbstractTransformerObject() {
    ...
    override fun permit(className: String?, superName: String?, interfaces: Array<String?>) =
        "io/netty/handler/codec/http/websocketx/WebSocketClientHandshaker" == superName

    override fun transform(className: String, ctClass: CtClass) {
        logger.info { "transform: Starting NettyWsClientTransformer..." }
        ctClass.getMethod("newHandshakeRequest", "()Lio/netty/handler/codec/http/FullHttpRequest;")
            .insertCatching(
            ...
            if (${this::class.java.name}.INSTANCE.${this::hasHeaders.name}()) { 
                ...
                while (iterator.hasNext()) {
                    ...
                    ${'$'}_.headers().set((String) entry.getKey(), entry.getValue());
                }
