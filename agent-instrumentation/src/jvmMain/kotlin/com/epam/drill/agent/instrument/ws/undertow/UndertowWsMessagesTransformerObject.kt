...
abstract class UndertowWsMessagesTransformerObject(agentParameters: AgentParameters) : HeadersProcessor,
    PayloadProcessor, AbstractWsTransformerObject(agentParameters) {
